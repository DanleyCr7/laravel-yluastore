                        ...
                        <div class="back-link-row">
                                <ul class="list-back-link" >
                                    ...
                                    @foreach ($categoria->subcategorias as $subcategoria)
                                        <li><a href="#" data-subcategoria_id="{{$subcategoria->id}}" class="redirect-back-link subcategoria-link" title="mobile">{{ $subcategoria->descricao ?? '[NÃO INFORMADO]' }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                            @endforeach
        ...
        <div class="coppy-right-box">
            <div class="container">
                <div class="coppy-right-item item-left">
                    <p class="coppy-right-text">Copyright © 2022 Ylua Store. Todos os direitos reservados</p>
                </div>
                <div class="coppy-right-item item-right">
                    <div class="wrap-nav horizontal-nav">
                        <ul>
                            <li class="menu-item"><a href="#" class="link-term">Sobre nós</a></li>								
                            <li class="menu-item"><a href="#" class="link-term">Politica de privacidade</a></li>
